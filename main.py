"""
BugScanner — Static analysis with LLM-driven bug detection
...
log = logging.getLogger("bugscanner")
...
class Router:
    """Cost- and latency-aware model router for BugScanner."""
...
if __name__ == "__main__":
    import argparse
    p = argparse.ArgumentParser(description="BugScanner: Static analysis with LLM-driven bug detection")
